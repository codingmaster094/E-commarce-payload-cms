        ...
        <div className="lg:col-span-5 space-y-6">
          <div>
            ...
            <div className="mt-3 flex items-center gap-3">
              <div className="flex text-amber-500 text-sm">ΓÿàΓÿàΓÿàΓÿàΓÿà</div>
              <span className="text-xs font-bold text-neutral-900">{product.rating}</span>
              <span className="text-neutral-300">ΓÇó</span>
          ...
          <div className="space-y-3 pt-2">
            ...
            >
              Add to Cart ΓÇö ${(product.price * quantity).toFixed(2)}
            </button>
        ...
        <div className="bg-white p-5 sm:p-8 rounded-2xl border border-neutral-100 shadow-sm">
            ...
            <div className="max-w-3xl space-y-6">
              ...
              <div className="divide-y divide-neutral-200 border-y border-neutral-200">
                ...
                <div className="py-3 grid grid-cols-2 text-xs">
                  <span className="font-semibold text-neutral-500">Dimensions (W ├ù D ├ù H)</span>
                  <span className="font-bold text-neutral-900">
                    {product.dimensions.width} ├ù {product.dimensions.depth} ├ù {product.dimensions.height}
                  </span>
                </div>
                <div className="py-3 grid grid-cols-2 text-xs">
          ...
          {activeTab === 'shipping' && (
            <div className="space-y-4 max-w-3xl text-xs sm:text-sm text-neutral-700 leading-relaxed">
              ...
              <p>
                All MEANOVA chairs ship free via insured freight. Orders placed before 2:00 PM EST are dispatched same-day and typically arrive within 2ΓÇô4 business days.
              </p>
            ...
            <div className="space-y-6 max-w-3xl" id="reviews">
              ...
              <div className="p-4 bg-neutral-50 rounded-xl border border-neutral-100 space-y-2 text-xs">
                <div className="flex items-center justify-between">
                  <span className="font-bold text-neutral-900">Jonathan S. ΓÇö Verified Buyer</span>
                  <span className="text-amber-500 font-bold">ΓÿàΓÿàΓÿàΓÿàΓÿà</span>
                </div>
                <p className="text-neutral-700">
                  ΓÇ£Absolutely worth every penny. The lumbar matrix support cured my neck stiffness after long engineering design sprints.ΓÇ¥
                </p>
              </div>
            </div>
          )}
